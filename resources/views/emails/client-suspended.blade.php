...
Your account has been suspended and your access to the client portal has been disabled.

@if($reason)
**Reason:** {{ $reason }}
@endif

If you believe this is a mistake or would like to resolve this, please contact our support team.
